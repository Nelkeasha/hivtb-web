        ...
        >
          {FORMATS.map((fmt, i) => {
            ...
            return (
              ...
              >
                <Icon size={16} style={{ color: '#E64B2E' }} className="mt-0.5 shrink-0" />
                ...
                {downloading === fmt.value && (
                  <span className="w-3 h-3 mt-1 border-2 border-current border-t-transparent rounded-full animate-spin shrink-0" style={{ color: '#E64B2E' }} />
                )}
              </button>
            );
          })}
