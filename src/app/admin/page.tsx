...
export default function AdminDashboard() {
  ...
  const staffBars = [
    { label: 'Community Health Workers', value: report?.totalChw ?? 0,        color: '#E74A2E' },
                ...
                <tbody>
                  {facilityTable.paged.map((f, i) => (
                    <tr key={i} className="table-row-hover" style={{ borderBottom: '1px solid #F0F0F0' }}>
                      ...
                      <td className="py-3 pr-6 data-num text-[13px] font-semibold" style={{ color: '#E74A2E' }}>{f.activePatients}</td>
