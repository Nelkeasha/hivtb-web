        ...
        {resetResult && (
          ...
          >
            ...
            >
              ...
              >
                <p className="data-num text-[22px] font-semibold tracking-widest" style={{ color: '#E64B2E' }}>
                  {resetResult.pass}
                </p>
              </div>
              ...
              <div className="flex gap-1 flex-wrap">
                {ROLES.map((r) => (
                  <button
                    ...
                    style={{
                      background: roleFilter === r ? '#E64B2E' : '#FAFAFA',
                      color: roleFilter === r ? '#fff' : '#6B7280',
                      border: `1px solid ${roleFilter === r ? '#E64B2E' : '#E9E9E9'}`,
                    }}
                  >
                      ...
                      <td className="py-3 pr-6">
                        <div className="flex items-center gap-2.5">
                          <div
                            ...
                            style={{ background: u.isActive ? '#E64B2E' : '#9CA3AF' }}
                          >
                      ...
                      <td className="py-3">
                        <div className="flex items-center gap-1">
                          ...
                          <button
                            ...
                            onMouseEnter={e => { (e.currentTarget as HTMLButtonElement).style.background = '#FAFAFA'; (e.currentTarget as HTMLButtonElement).style.color = '#E64B2E'; }}
